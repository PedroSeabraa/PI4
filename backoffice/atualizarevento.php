...
require 'dbconfig.php';
	...
	preco='$_POST[preco]',preco_f='$_POST[precof]',preco_refeicao='$_POST[precor]' 
    ,preco_acomp='$_POST[precoa]' ,data_inicio='$_POST[data]' ,tipo_evento='$_POST[tipo]' 
    ,foto='$_POST[foto]' ,longitude='$_POST[longitude]' ,latitude='$_POST[latitude]' 
